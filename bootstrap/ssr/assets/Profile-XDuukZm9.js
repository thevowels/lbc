  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6 flex space-x-2", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
        ...
        chirp.user_id === auth.user.id && /* @__PURE__ */ jsxs(Dropdown, { children: [
...
function Profile({ auth, user, chirps, route: route2 }) {
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "User Profile" }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto p-4 sm:p-6 lg:p-8", children: [
      /* @__PURE__ */ jsx("h1", { children: user.name }),
      /* @__PURE__ */ jsx("h2", { children: user.email }),
      /* @__PURE__ */ jsxs("h2", { children: [
        "Welcome to the site ",
        user.name
      ] }),
      /* @__PURE__ */ jsx("h2", { children: route2 }),
      /* @__PURE__ */ jsxs("div", { className: "mt-6 bg-white shadow-sm rounded-lg divide-y", children: [
        /* @__PURE__ */ jsx("h2", { children: "adsf" }),
        chirps.map(
          (chirp) => /* @__PURE__ */ jsx(UserChirp, { chirp, user }, chirp.id)
        )
      ] })
    ] })
  ] });
